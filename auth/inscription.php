...
<head>
    ...
    <style>
        ...
        .image-side {
            ...
            background-size: cover; background-position: center; display: flex; flex-direction: column; justify-content: center; padding: 4rem; color: white;
        }
        .form-side { background-color: #fff; display: flex; align-items: center; justify-content: center; padding: 3rem; }
        .register-form { width: 100%; max-width: 500px; }
        .input-group-text { background-color: #f8f9fa; border-right: 0; }
        .form-control { border-left: 0; }
        .form-control:focus { border-left: 1px solid var(--primary-color); }
        @media (max-width: 991.98px) { .image-side { display: none; } }
    </style>
</head>
<body>
