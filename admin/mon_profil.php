...
<body>
    ...
    <div class="main-content">
        <div class="d-flex justify-content-between align-items-center mb-4">
            <h2 class="fw-bold">Mon Profil Administrateur</h2>
        </div>
                            ...
                            <div class="row g-3">
                                <div class="col-md-6">
                                    ...
                                    <input type="text" name="nom" class="form-control"
                                        value="<?php echo htmlspecialchars($admin['nom_utilisateur'] ?? ''); ?>"
                                        required>
                                </div>
                                <div class="col-md-6">
                                    <label class="form-label text-muted small fw-bold">Prénom</label>
                                    <input type="text" name="prenom" class="form-control"
                                        value="<?php echo htmlspecialchars($admin['prenom_utilisateur'] ?? ''); ?>"
                                        required>
                                </div>
                                <div class="col-md-6">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="email" name="email" class="form-control"
                                            value="<?php echo htmlspecialchars($admin['email_utilisateur'] ?? ''); ?>"
                                            required>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="tel" class="form-control"
                                            value="<?php echo htmlspecialchars($admin['tel_utilisateur'] ?? ''); ?>"
                                            required>
                                    </div>
                                </div>
                                <div class="col-12 mt-4 text-end">
                                    <button type="submit" class="btn btn-primary shadow-sm"><i
                                            class="bi bi-save me-2"></i> Enregistrer les modifications</button>
                                </div>
                            </div>
                        </form>
                    </div>
                    ...
                    <div class="card-body p-4">
                        <form method="POST">
                            ...
                            <div class="text-end mt-4">
                                <button type="submit" class="btn btn-danger shadow-sm"><i
                                        class="bi bi-shield-lock me-2"></i> Modifier le mot de passe</button>
                            </div>
                        </form>
                    </div>
                </div>
